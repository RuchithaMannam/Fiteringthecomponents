//filter the products which contain tea and calculate the total for each year.//
import java.util.*;
...
public class Filter
{
    public static void main(String args[])
    {
        ...
        Map<Integer,Double>teaTotalsByYear=products.stream().filter(p->p.getName().contains("Tea")).collect(Collectors.groupingBy(Product::getYear,Collectors.summingDouble(Product::getPrice)));
